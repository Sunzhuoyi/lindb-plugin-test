...
import { LindbQuery, LindbOptions } from '../types';

import LindbQueryField from './LindbQueryField';
import LindbLink from './LindbLink';
export type Props = QueryEditorProps<LindbDatasource, LindbQuery, LindbOptions>;
...
export class LindbQueryEditor extends PureComponent<Props, State> {
  ...
  onFieldChange = (query: LindbQuery, override?: any) => {
      ...
      <div>
        ...
        to a multiple of the interval step."
          ...
          <div className="gf-form">
            ...
            <FormLabel width={10} tooltip="Link to Graph in Lindbetheus">
              <LindbLink
                datasource={datasource}
